...
class Plugin:
    ...
    def __init__(self):
        ...
        self.smileys = {
            ...
            "Fuck you!" : [244, 251],
            "Garfield" : [277],
            "Haha" : [240, 242, 405, 931, 551, 324, 754],
            "Ham ham" : [326],
            "Hamburger" : [264],
            "Hehe" : [246, 737, 432, 970, 789, 77, 732],
            "High five" : [813],
            "Hihi" : [470, 763, 659],
            "Hipík" : [759],
            "Hladí po hlavě" : [831],
            ...
            "Oči v sloup" : [642],
            "Pacman" : [520],
            "Palec nahoru" : [606, 1042, 181, 319],
            "Papa" : [623, 426],
            "Pavouk" : [88],
            "Pes" : [903, 627],
            "Pije" : [862],
            "Piju sám" : [401],
            "Pivo" : [261, 239, 997, 216],
            ...
            "Vodí kačera" : [431],
            "Vyděšený" : [1071],
            "Vyplazuje jazyk" : [512, 996, 346, 64],
            "Vyvaluje oči" : [219, 234, 209],
            "Zadek" : [955],
            "Zasněný" : [999],
